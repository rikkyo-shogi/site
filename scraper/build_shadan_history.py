...
RECORDS = [
    ...
    (28, "H29", "平成29年度", "28/5nitimeseisekijun1.pdf", [
        (UNIV, "立教大紫龍会", "4部白", 16, 2, 36, "降級", "翌回5部赤所属より判定。"),
    ]),
    (29, "H30", "平成30年度", "29/5nitimeseisekijun1.pdf", [
        (UNIV, "立教大紫龍会", "5部赤", 5, 10, 62.5, None, ""),
    ]),
...
ONGOING = (
    35, "R08", "令和8年度", "第3節終了時点の途中経過",
    "35/35_league_03_u.pdf",
    [
        (UNIV, "立教大学紫龍会", "4部白", 8, 7, 40, None, "第3節終了時点で7勝5敗(前節4位から8位へ後退)。"),
        (OB, "紫龍会", "6部白", 13, 5, 27, None, "第3節終了時点で5勝7敗(前節から順位変わらず13位)。"),
    ],
)
